public class Attribute
{
	...
	public AttributeOption[] choices; //The choices associated with this attribute
	public int numExamples = 0; //The number of examples given with this attribute.
	public int positiveExamples = 0; //The number of examples given with this attribute that have a positive outcome.
	public int negativeExamples = 0; //The number of examples given with this attribute that have a negative outcome.
